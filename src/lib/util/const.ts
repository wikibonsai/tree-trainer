...
export const URL_REPO_TREE_TRAINER : string = 'https://github.com/wikibonsai/tree-trainer';
// social
...
export const URL_TWT_TREE          : string = 'https://x.com/wibomd/status/1787578468550520896';
// ai
// api
